[![window widget](https://window-lemon.vercel.app/api/Window?titleBar=BackendDev&title=Arganta&desc=Backend+developer+with+a+strong+focus+on+Golang%2C+system+design%2C+and+API+development.+Interested+in+security%2C+performance%2C+and+building+reliable+server-side+applications.&theme=dark)](https://github.com/argnta)

## About Me
Backend developer with a strong interest in system design, performance, and security.  
Focused on building clean, reliable, and scalable server-side applications.
...
## Activity Graph
![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=argnta&theme=github-compact)
